    ...
    <div class="row justify-content-center d-flex mt-5">
        <div class="col-md-12">
            ...
            <div class="row mt-4">
                ...
                @else
                    <img src="https://placehold.co/260x400?text=NO Image" alt="">
                @endif
                </div>
                <div class="col-md-8">
                    ...
                    <div class="h4 text-light">{{ $book->author }}</div>
                    <div class="star-rating d-inline-flex ml-2" title="">
                        ...
                        <span class="theme-font text-secondary">(0 Review)</span>
                    </div>
                            ...
                            <div class="card border-0 shadow-lg">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="star-rating d-inline-flex ml-2" title="">
                                        ...
                                        <span class="theme-font text-light">(0)</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12  mt-4">
                            <div class="d-flex justify-content-between">
                                ...
                                <div>
                                    ...
                                    @else
                                    <a href="{{ route('account.login') }}" class="btn btn-light">Add Review</a>
                                    @endif
